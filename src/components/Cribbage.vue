    ...
    export default {
        ...
        methods: {
            calculatePoints() {
                ...
                const cardsValueMap = helpers.createCardHash(this.cardValues);
                const cardsFaceMap = helpers.createCardHash(this.cardFaces);
                this.getSumPoints(this.cardValues, cardsValueMap, this.total);
            ...
            getSumPoints(cardValues, cardsMap, target) {
                helpers.getSumPoints(cardValues, cardsMap, target);
            },
            cardsToFaceValues() {},
        },
    };
